...
async function main(namePackage: string) {
  ...
  // [RU] На случай, если хотите сделать demo. Скрипт будет искать в 'src' файл 'src/demo.ts'
  // [EN] In case you want to demo. The script will look in 'src' for the file 'src/demo.ts'
  //
